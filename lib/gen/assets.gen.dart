...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/bath.png
  AssetGenImage get bath => const AssetGenImage('assets/icons/bath.png');

  /// File path: assets/icons/bed.png
  AssetGenImage get bed => const AssetGenImage('assets/icons/bed.png');

  /// List of all assets
  List<AssetGenImage> get values => [bath, bed];
}
